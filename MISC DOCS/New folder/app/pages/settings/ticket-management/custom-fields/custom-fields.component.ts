...
import { CustomFieldsService } from '../../../../../services/LocalServices/CustomFieldsService';
...
export class CustomFieldsComponent implements OnInit {
	...
	constructor(private _customFieldService: CustomFieldsService,
		...
		this.subscriptions.push(_authService.getPackageInfo().subscribe(pkg => {
			if (pkg) {
				this.package = pkg.tickets.customFields;
		...
		this.subscriptions.push(this._authService.getSettings().subscribe(data => {
			if (data && data.permissions) {
				this.customFieldPermissions = data.permissions.settings.ticketManagement.customFields;
			}
		}));
