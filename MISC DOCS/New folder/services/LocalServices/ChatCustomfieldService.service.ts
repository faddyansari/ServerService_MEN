...
@Injectable()
export class ChatCustomFieldServiceService {
    ...
    public GetFields() {
        this.Socket.emit('getChatCustomFields', {}, (response) => {
    ...
    public UpdateFields(data): Observable<any> {
        return new Observable(observer => {
            ...
            this.Socket.emit('updateChatCustomFields', { fields: data.fields }, (response) => {
