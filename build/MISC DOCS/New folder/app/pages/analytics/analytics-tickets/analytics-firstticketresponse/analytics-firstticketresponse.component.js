...
exports.AnalyticsFirstticketresponseComponent = void 0;
var core_1 = require("@angular/core");
var Highcharts = require("highcharts");
require('highcharts/modules/exporting')(Highcharts);
var AnalyticsFirstticketresponseComponent = /** @class */ (function () {
    function AnalyticsFirstticketresponseComponent(_authService, _analyticsService) {
        var _this = this;
        ...
        this.subscriptions.push(_analyticsService.options.subscribe(function (data) {
            if (_this.rendered) {
                if (data.title.text) {
                    _this.options.title.text = 'First Ticket Response (' + _this.time_convert(data.title.text) + ')';
                }
    ...
    AnalyticsFirstticketresponseComponent.prototype.ngOnInit = function () {
    };
    AnalyticsFirstticketresponseComponent.prototype.onFilterResult = function (event) {
        var _this = this;
        this._analyticsService.GetFirstTicketResponse(event.csid, event.selectedDateType, event.selectedDate, event.selectedAgents).subscribe(function (data) {
            ...
            if (event.comparison) {
                ...
                if (event.selectedComparison.match(/days/g)) {
                    ...
                    if (!data.json().length) {
                        _this._analyticsService.updateChart('column', daysData, 'dimensional', 'Response Time', true);
                    }
                    else {
                        _this._analyticsService.updateChart('column', daysData, 'dimensional', 'Response Time', false, totalResponse);
                    }
                }
                    ...
                    if (!data.json().length) {
                        _this._analyticsService.updateChart('column', monthsData, 'flat', 'Response Time', true);
                    }
                    else {
                        _this._analyticsService.updateChart('column', monthsData, 'flat', 'Response Time', false, totalResponse);
                    }
                }
                    ...
                    if (!data.json().length) {
                        _this._analyticsService.updateChart('column', yearsData, 'dimensional', 'Response Time', true);
                    }
                    else {
                        _this._analyticsService.updateChart('column', yearsData, 'dimensional', 'Response Time', false, totalResponse);
                    }
                }
            }
            else {
                if (!event.selectedAgents.length) {
                    switch (event.selectedDateType) {
                        ...
                        case 'yesterday':
                            ...
                            if (!data.json().length) {
                                _this._analyticsService.updateChart('column', firstHalf_1.concat(secondHalf_1), 'flat', 'Response Time', true);
                                // return;
                            }
                            else {
                                _this._analyticsService.updateChart('column', firstHalf_1.concat(secondHalf_1), 'flat', 'Response Time', false, totalResponse);
                            }
                            break;
                        case 'week':
                            var graph_week_1 = [];
                            ...
                            if (!data.json().length) {
                                _this._analyticsService.updateChart('column', graph_week_1, 'flat', 'Response Time', true);
                                // return;
                            }
                            else {
                                _this._analyticsService.updateChart('column', graph_week_1, 'flat', 'Response Time', false, totalResponse);
                            }
                            break;
                        case 'month':
                            var graph_month_1 = [];
                            ...
                            if (!data.json().length) {
                                _this._analyticsService.updateChart('column', graph_month_1, 'flat', 'Response Time', true);
                                // return;
                            }
                            else {
                                _this._analyticsService.updateChart('column', graph_month_1, 'flat', 'Response Time', false, totalResponse);
                            }
                            break;
                        default:
                            ...
                            if (_this._analyticsService.daysBetween(date1, date2) == 0 || _this._analyticsService.daysBetween(date1, date2) == 1) {
                                ...
                                if (!data.json().length) {
                                    _this._analyticsService.updateChart('column', firstHalf_2.concat(secondHalf_2), 'flat', 'Response Time', true);
                                    // return;
                                }
                                else {
                                    _this._analyticsService.updateChart('column', firstHalf_2.concat(secondHalf_2), 'flat', 'Response Time', false, totalResponse);
                                }
                            }
                                ...
                                if (!data.json().length) {
                                    _this._analyticsService.updateChart('column', graph_week_2, 'flat', 'Response Time', true);
                                    // return;
                                }
                                else {
                                    _this._analyticsService.updateChart('column', graph_week_2, 'flat', 'Response Time', false, totalResponse);
                                }
                            }
                            else {
                                var graph_month_2 = [];
                                ...
                                if (!data.json().length) {
                                    _this._analyticsService.updateChart('column', graph_month_2, 'flat', 'Response Time', true);
                                    // return;
                                }
                                else {
                                    _this._analyticsService.updateChart('column', graph_month_2, 'flat', 'Response Time', false, totalResponse);
                                }
                            }
                            break;
                    }
                    ...
                    switch (event.selectedDateType) {
                        ...
                        case 'yesterday':
                            ...
                            if (!data.json().length) {
                                _this._analyticsService.updateChart('column', graph_agents_1, 'flat', 'Response Time', true);
                                // return;
                            }
                            else {
                                _this._analyticsService.updateChart('column', graph_agents_1, 'agents', 'Response Time', false, totalResponse);
                            }
                            break;
                        case 'week':
                            event.selectedAgents.forEach(function (agent) {
    ...
    AnalyticsFirstticketresponseComponent.prototype.ngAfterViewInit = function () {
        this.chart = new Highcharts.Chart("highchart", this.options);
        this.rendered = true;
    };
    AnalyticsFirstticketresponseComponent.prototype.time_convert = function (num) {
        // num = Math.round(num); 
        var days = Math.floor((num / 24) / 60);
        var hours = Math.floor((num / 60) % 24);
        var minutes = Math.round(num % 60);
    ...
    AnalyticsFirstticketresponseComponent.prototype.showTotal = function (indexExists, index) {
        var count = 0;
        if (indexExists) {
    ...
    AnalyticsFirstticketresponseComponent.prototype.Export = function () {
    ...
    AnalyticsFirstticketresponseComponent.prototype.ngOnDestroy = function () {
        this.subscriptions.forEach(function (subscription) {
            subscription.unsubscribe();
        });
    };
    AnalyticsFirstticketresponseComponent = __decorate([
        core_1.Component({
    ...
    return AnalyticsFirstticketresponseComponent;
}());
exports.AnalyticsFirstticketresponseComponent = AnalyticsFirstticketresponseComponent;
//# sourceMappingURL=analytics-firstticketresponse.component.js.map