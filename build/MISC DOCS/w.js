...
{
    "_id";
    "5e0c478e5529e62888e0eb41", "group_name";
    "group next", "group_desc";
    "desc next", "agent_list";
    [{ "email": "anasayyubi@gmail.com", "count": 5, "isAdmin": false, "excluded": false }, { "email": "f@f.com", "count": 0, "isAdmin": false, "excluded": false }, { "email": "bali@local.com", "count": 1, "isAdmin": false, "excluded": false }], "auto_assign";
    {
        "enabled";
        false, "type";
        "roundrobin";
    ...
    "nsp";
    "/localhost.com", "generalSettings";
    {
        "assignmentLimit";
        2, "enabled";
        true, "fallbackLimitExceed";
        "mufahad9213@sbtjapan.com", "fallbackNoShift";
        "mufahad9213@sbtjapan.com", "unAvailibilityHours";
        [{ "weekDay": "Mon", "duration": 8, "startTime": "33:00" }, { "weekDay": "Tue", "duration": 8, "startTime": "34:0" }, { "weekDay": "Wed", "duration": 8, "startTime": "34:60" }, { "weekDay": "Thurs", "duration": 8, "startTime": "36:00" }, { "weekDay": "Fri", "duration": 8, "startTime": "37:0" }, { "weekDay": "Sat", "duration": 8, "startTime": "37:60" }, { "weekDay": "Sun", "duration": 8, "startTime": "39:00" }], "unEntertainedTime";
        5;
    }
}
db.emailRecipients.find({}).forEach(function (x) {
...
db.companies.find({}).forEach(function (x) {
    Object.keys(x.settings.permissions).map(function (key) {
...
use;
agentsDB;
db.agents.find({}).forEach(function (x) {
...
//Agent creation
{
    ...
    '/beelinks.solutions',
        created_date;
    '2020-01-21T15:31:12.005Z',
        created_by;
    'dev.bizzchats@gmail.com',
        editsettings;
    {
        editprofilepic: true,
            editname;
    ...
    settings: {
        simchats: true,
            emailNotifications;
        {
            newTickCreate: true, assignToAgent;
            true, unattendTickGroup;
            true, repliesToTicket;
            true, noteAddTick;
            true, agentInviteEmail;
            true;
        }
        windowNotifications: {
            newTicket: true, ticketMessage;
            true, ticketAssigned;
            true, ticketUpdated;
            true, agentConversation;
            true;
        }
    }
}
