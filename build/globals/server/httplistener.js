...
var HTTPListener = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, __biZZCMiddleWare_1.__biZZC_Core.InitApplication()];
                    case 1:
                        _a.sent();
                    ...
                    case 2:
                        ...
                        setTimeout(function () { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, __biZZCMiddleWare_1.__biZZC_Core.InitApplication()];
                                    case 1:
                                        _a.sent();
                                        return [2 /*return*/];
                                }
    ...
    HTTPListener.prototype.InitSocketMiddleWare = function () {
        return __awaiter(this, void 0, void 0, function () {
            var error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, __biZZCMiddleWare_1.__biZZC_Core.RegisterSocketMiddleWare()];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
    ...
    HTTPListener.prototype.StartHttpServer = function () {
        return __biZZCMiddleWare_1.__biZZC_Core.Application.listen(Constants.port, function () {
