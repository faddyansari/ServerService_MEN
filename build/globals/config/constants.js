...
exports.Pricing = exports.machineIP = exports.ActionsUrls = exports.defaultSettings = exports.rand = exports.decrypt = exports.GenerateOrderID = exports.encrypt = exports.Assets = exports.tokenSignature = exports.Groups = exports.Namespaces = exports.packageCodesDirect = exports.packageCodesCard = exports.subscriptionThankYouPath = exports.subscriptionSuccessPath = exports.subscriptionURLDirect = exports.subscriptionURL = exports.FixCount = exports.AGENTSOLRQUEUE = exports.TIMEOUTKEYNAME = exports.REDISQUEUENAME = exports.REDISMQPORT = exports.REDISMQURL = exports.REDISURL = exports.REST_SOCKET_QUEUE = exports.SQSChatsSOLRURL = exports.SQSSOLRURL = exports.ARCHIVINGQUEUE = exports.AnalytcisNewQueue = exports.SQSURL = exports.WEBSITEURL = exports.bucketName = exports.serverAddress = exports.ticketEmail = exports.EmailTest = exports.port = void 0;
...
exports.REDISQUEUENAME = (process.env.NODE_ENV == 'production') ? 'socket_event_bus' : (process.env.QUEUENAME) ? process.env.QUEUENAME : 'event_bus_local_murtaza989';
exports.TIMEOUTKEYNAME = (process.env.NODE_ENV == 'production') ? 'timeoutKey_Prod' : (process.env.TIMEOUTKEYNAME) ? process.env.TIMEOUTKEYNAME : 'timeoutKey_murtaza989';
