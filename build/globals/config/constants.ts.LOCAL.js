...
exports.REDISQUEUENAME = (process.env.NODE_ENV == 'production') ? 'socket_event_bus' : (process.env.QUEUENAME) ? process.env.QUEUENAME : 'event_bus_local_murtaza123';
exports.TIMEOUTKEYNAME = (process.env.NODE_ENV == 'production') ? 'timeoutKey_Prod' : (process.env.TIMEOUTKEYNAME) ? process.env.TIMEOUTKEYNAME : 'timeoutKey_murtaza123';
...
//# sourceMappingURL=constants.ts.LOCAL.js.map