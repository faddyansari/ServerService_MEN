...
var AgentsDB = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 5, , 6]);
                        if (!!AgentsDB.Instance) return [3 /*break*/, 3];
                        AgentsDB.Instance = new AgentsDB();
                        return [4 /*yield*/, AgentsDB.Instance.connectDatabase(prodURI)];
                    case 2:
                        mongoClient = _a.sent();
                        AgentsDB.Instance.dataBase = mongoClient.db(dbName);
                        AgentsDB.Instance.onClose(AgentsDB.Instance.dataBase, prodURI);
                        console.log("connected to Database ");
                        console.log("Database Name : " + AgentsDB.Instance.dataBase.databaseName);
                        return [2 /*return*/, AgentsDB.Instance.dataBase];
                    case 3: return [2 /*return*/, AgentsDB.Instance.dataBase];
    ...
    AgentsDB.prototype.reconnect = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    AgentsDB.prototype.onClose = function (db, prodURI) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                ...
                                AgentsDB.Instance.dataBase.removeAllListeners();
                                return [4 /*yield*/, AgentsDB.Instance.connectDatabase(prodURI)];
                            case 2:
                                mongoClient = _a.sent();
                                AgentsDB.Instance.dataBase = mongoClient.db(dbName);
    ...
    AgentsDB.prototype.connectDatabase = function (prodURI) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    AgentsDB.prototype.SendEmail = function (type) {
        return __awaiter(this, void 0, void 0, function () {
            var obj;
            return __generator(this, function (_a) {
    ...
    AgentsDB.prototype.disconnect = function () {
        if (AgentsDB.Instance && AgentsDB.Instance.dataBase) {
            AgentsDB.Instance.dataBase.close();
        }
        else {
...
exports.AgentsDB = AgentsDB;
//# sourceMappingURL=AgentsDB.js.map