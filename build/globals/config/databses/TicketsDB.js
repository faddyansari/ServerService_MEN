...
var TicketsDB = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 5, , 6]);
                        if (!!TicketsDB.Instance) return [3 /*break*/, 3];
                        TicketsDB.Instance = new TicketsDB();
                        return [4 /*yield*/, TicketsDB.Instance.connectDatabase(prodURI)];
                    case 2:
                        mongoClient = _a.sent();
                        ...
                        return [2 /*return*/, TicketsDB.Instance.dataBase];
                    case 3: return [2 /*return*/, TicketsDB.Instance.dataBase];
    ...
    TicketsDB.prototype.reconnect = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    TicketsDB.prototype.onClose = function (db, prodURI) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
    ...
    TicketsDB.prototype.connectDatabase = function (prodURI) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, mongodb_1.MongoClient.connect(prodURI, { useNewUrlParser: true, useUnifiedTopology: false, reconnectTries: 60, reconnectInterval: 60000, autoReconnect: true })];
                    case 1:
                        client = _a.sent();
                        // client.db(dbName);
    ...
    TicketsDB.prototype.SendEmail = function (type) {
        return __awaiter(this, void 0, void 0, function () {
            var obj;
            return __generator(this, function (_a) {
    ...
    TicketsDB.prototype.disconnect = function () {
