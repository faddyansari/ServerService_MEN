...
var EventLogs = /** @class */ (function () {
    function EventLogs() {
    }
    EventLogs.Initialize = function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _a.db = _c.sent();
                        _b = this;
                        return [4 /*yield*/, this.db.createCollection('eventLogs')];
                    case 2:
                        _b.collection = _c.sent();
                        EventLogs.initialized = true;
                        //console.log(this.collection.collectionName);
                        return [2 /*return*/, EventLogs.initialized];
                    case 3:
                        error_1 = _c.sent();
    ...
    EventLogs.createLog = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var error_2;
    ...
    EventLogs.getLogs = function (visitorId) {
        return __awaiter(this, void 0, void 0, function () {
            var error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.collection.find({ sessionid: new bson_1.ObjectId(visitorId) }).toArray()];
