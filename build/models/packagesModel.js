...
var PackagesModel = /** @class */ (function () {
    function PackagesModel() {
    }
    PackagesModel.Initialize = function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _a.db = _c.sent();
                        _b = this;
                        return [4 /*yield*/, this.db.createCollection('packages')];
                    case 2:
                        _b.collection = _c.sent();
                        console.log(this.collection.collectionName);
                        PackagesModel.initialized = true;
                        return [2 /*return*/, PackagesModel.initialized];
                    case 3:
                        error_1 = _c.sent();
    ...
    PackagesModel.GetPackageByName = function (name) {
        return __awaiter(this, void 0, void 0, function () {
            var error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.collection.find({ name: name }).limit(1).toArray()];
    ...
    PackagesModel.initialized = false;
    return PackagesModel;
}());
exports.PackagesModel = PackagesModel;
//# sourceMappingURL=packagesModel.js.map