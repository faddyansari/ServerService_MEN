...
exports.iconIntegrationRoutes = void 0;
...
router.post('/MasterData', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var data, masterDataProductionURL, masterData, response, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
...
router.post('/GetOtherPorts', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var result, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, widgetMarketingModel_1.WidgetMarketingModel.getOtherPorts()];
            case 1:
                result = _a.sent();
...
router.post('/SalesAgent', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var data, SalesAgentDevelopmentURL, SalesAgentStagingURL, agentsList, response, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
...
router.post('/CarNameMasterData', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var data, carNameDevelopmentURL, carNameStagingURL, carNameProductionURL, carName, response, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
...
router.post('/CarModelMasterData', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var data, carModelDevelopmentURL, carModelStagingURL, carModelProductionURL, carModel, response, error_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
...
exports.iconIntegrationRoutes = router;
//# sourceMappingURL=iconIntegration.js.map