...
export const EmailTest = true;

export const ticketEmail = (process.env.NODE_ENV == 'production') ? 'support@bizzchats.com' : 'tickets@app.beelinks.solutions';

export const serverAddress = (process.env.NODE_ENV == 'production') ? 'https://app.beelinks.solutions' : (process.env.NODE_ENV == 'development') ? 'https://dev.beelinks.solutions' : 'http://localhost:8000';

export const bucketName = (process.env.NODE_ENV == 'production') ? 'beelinksemail-notifications' : 'beelinks-notifification-local'

export const WEBSITEURL = (process.env.NODE_ENV == 'production') ? 'https://beelinks.solutions' : (process.env.NODE_ENV == 'development') ? 'https://websiteqa.beelinks.solutions' : 'http://localhost:8006'
export const SQSURL = (process.env.NODE_ENV == 'production') ? 'https://sqs.us-west-2.amazonaws.com/021594099427/Socket-Email-Queue-Production' : 'https://sqs.us-west-2.amazonaws.com/021594099427/Socket-Email-Queue'


export const AnalytcisNewQueue = (process.env.NODE_ENV == 'production') ? 'https://sqs.us-west-2.amazonaws.com/021594099427/CHATENDQUEUE-Production' : 'https://sqs.us-west-2.amazonaws.com/021594099427/CHATENDQUEUE'
export const ARCHIVINGQUEUE = (process.env.NODE_ENV == 'production') ? 'https://sqs.us-west-2.amazonaws.com/021594099427/Analytics-Old-Production' : 'https://sqs.us-west-2.amazonaws.com/021594099427/Analytics-Old'

export const SQSSOLRURL = 'https://sqs.us-west-2.amazonaws.com/021594099427/TICKET-SOLR.fifo';
export const SQSChatsSOLRURL = 'https://sqs.us-west-2.amazonaws.com/021594099427/Conversation-SOLR.fifo';

export const REST_SOCKET_QUEUE = (process.env.NODE_ENV == 'production') ? 'https://sqs.us-west-2.amazonaws.com/021594099427/Rest-Socket-Production.fifo' : 'https://sqs.us-west-2.amazonaws.com/021594099427/Rest-Socket-Local.fifo';
export const REDISURL = (process.env.NODE_ENV == 'production') ? 'redis://cch2.beelinks.solutions:6379' : 'redis://34.221.164.186:8000'
export const REDISMQURL = (process.env.NODE_ENV == 'production') ? 'cch2.beelinks.solutions' : '34.221.164.186';
export const REDISMQPORT = (process.env.NODE_ENV == 'production') ? 6379 : 8000
export const REDISQUEUENAME = (process.env.NODE_ENV == 'production') ? 'socket_event_bus' : (process.env.QUEUENAME) ? process.env.QUEUENAME : 'event_bus_local_murtaza989'
export const TIMEOUTKEYNAME = (process.env.NODE_ENV == 'production') ? 'timeoutKey_Prod' : (process.env.TIMEOUTKEYNAME) ? process.env.TIMEOUTKEYNAME : 'timeoutKey_murtaza989';
export const AGENTSOLRQUEUE = 'https://sqs.us-west-2.amazonaws.com/021594099427/Agent-SOLR.fifo';
export let FixCount = false;
// export let ConcurrentChatLimit = 20;

export const subscriptionURL = 'https://subscription-module.azurewebsites.net/Payment/GetPaymentURL/';
export const subscriptionURLDirect = '	https://subscription-module.azurewebsites.net/Payment/TakeDirectPayemnt/';
export const subscriptionSuccessPath = 'payment_complete';
export const subscriptionThankYouPath = 'thank_you';

export const packageCodesCard = {
  "agent": 'b595d220-b37b-4e24-acbe-05eebd009f0d',
  "honey-comb": '12ba199a-15d5-4360-8250-6220dea80ffd'
};

export const packageCodesDirect = {
...
export const Groups = { SBTPK: ['KE', 'PK'] }
...
export const Assets = JSON.parse(fs.readFileSync(assetsPath + '/manifest.json', 'utf-8'));

export function encrypt(text) {
  let cipher = crypto.createCipher(tokenSignature.algorithm, tokenSignature.signature)
...
export function decrypt(text) {
  let decipher = crypto.createDecipher(tokenSignature.algorithm, tokenSignature.signature)
...
export const rand = ['#9BB4DD', '#6B9ED4', '#F58758', '#FACE63', '#55C4CC', '#F7C138', '#8580BC', '#7BB446', '#E24050', '#EC59AA', '#F2AEBB', '#01DD9F', '#7AEDDE', '#01D2E9', '#06A1E4', '#A7A9E2', '#A190D7', '#FF99CB', '#FF2D36', '#F19645', '#99CDFF', '#FB896E', '#33BFBE', '#1982C4', '#838DB0', '#50BF94', '#963FC1'];
...
export const ActionsUrls = []


export const machineIP = (process.env.NODE_ENV == 'production') ? '172.31.18.205' : (process.env.NODE_ENV == 'development') ? '172.31.56.100' : '';
